/**
 * Test script for localized number formatting.
 * Verifies that date and time numbers are displayed using locale-specific numeral systems.
 * 
 * Run with: node scripts/test_localized_numbers.js
 */
